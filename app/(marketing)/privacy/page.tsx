        ...
        <Card className="p-8 sm:p-12">
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              ...
              <h3 className="text-xl font-semibold text-text-primary mb-3">Service Providers</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                We may share your information with third-party service providers who perform services on our behalf, 
                such as payment processing, data analysis, email delivery, hosting services, and customer service.
              </p>

              <h3 className="text-xl font-semibold text-text-primary mb-3">Business Transfers</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
                If we are involved in a merger, acquisition, or sale of assets, your information may be transferred 
                as part of that transaction.
              </p>

              <h3 className="text-xl font-semibold text-text-primary mb-3">Legal Requirements</h3>
              <p className="text-text-secondary leading-relaxed mb-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-text-secondary leading-relaxed">
                To exercise these rights, please contact us at <a href="mailto:belalabukhadija97@gmail.com" className="text-primary-400 hover:text-primary-300">belalabukhadija97@gmail.com</a>
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-text-secondary leading-relaxed">
                For more information about how we use cookies, please see our <a href="/cookies" className="text-primary-400 hover:text-primary-300">Cookie Policy</a>.
              </p>
            </section>
